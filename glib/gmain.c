                                 ...
                                 GThread      *self)
{
  ...
  g_main_context_poll_unlocked (context, timeout_usec/*超时时间*/, max_priority, fds, nfds);

  some_ready = g_main_context_check_unlocked (context, max_priority, fds/*入出参，各fd发生的事件*/, nfds);
